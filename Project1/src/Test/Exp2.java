...
//		frame.setVisible(true);
		...
		GuardMapping grdT2 = new GuardMapping();
		grdT2.condition= T2Ct1;
		grdT2.Activations.add(new Activation(t2, "P2", TransitionOperation.AddElement, "P3"));
		t2.GuardMappingList.add(grdT2);
		...
		grdT3.Activations.add(new Activation(t3, "P3", TransitionOperation.AddElement, "P1"));
		...
		Condition T4Ct1 = new Condition(t4, "P1", TransitionCondition.NotNull);
		Condition T4Ct2 = new Condition(t4, "P4", TransitionCondition.CanAddCars);
		T4Ct1.SetNextCondition(LogicConnector.AND, T4Ct2);

		GuardMapping grdT4 = new GuardMapping();
		grdT4.condition= T4Ct1;
		grdT4.Activations.add(new Activation(t4, "P1", TransitionOperation.AddElement, "P4"));
		...
		Condition T7Ct1 = new Condition(t7, "P2", TransitionCondition.NotNull);
		...
		grdT7.Activations.add(new Activation(t7, "P2", TransitionOperation.AddElement, "P7"));
		...
		Condition T9Ct1 = new Condition(t9, "P3", TransitionCondition.NotNull);
